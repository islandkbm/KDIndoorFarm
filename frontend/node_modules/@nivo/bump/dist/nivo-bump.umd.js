(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/axes'), require('d3-shape'), require('@nivo/colors'), require('@nivo/tooltip'), require('d3-scale'), require('prop-types'), require('@react-spring/web')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/axes', 'd3-shape', '@nivo/colors', '@nivo/tooltip', 'd3-scale', 'prop-types', '@react-spring/web'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.d3, global.nivo, global.nivo, global.d3, global.PropTypes, global['@react-spring/web']));
}(this, (function (exports, React, core, axes, d3Shape, colors, tooltip, d3Scale, PropTypes, web) { 'use strict';
  ...
  var computeSeries = function computeSeries(_ref) {
    ...
    var yScale = d3Scale.scalePoint().domain(yValues).range([0, height]).padding(yOuterPadding);
  ...
  var Point = function Point(_ref) {
    ...
    return React__default.createElement(web.animated.circle, {
      cx: animatedProps.x,
      cy: animatedProps.y,
      r: web.to(animatedProps.radius, function (v) {
        return Math.max(v, 0);
      }),
  ...
  var Line = function Line(_ref) {
    ...
    return React__default.createElement(React__default.Fragment, null, React__default.createElement(web.animated.path, {
      fill: "none",
      d: animatedPath,
